...
export class ProjetosController {
  ...
  async connectGithub(
    ...
    return this.projetosService.connectGithubRepo(
      projetoId,
      body.owner,
      body.repo,
      body.token,
  ...
  async getRepoFiles(
    ...
    // Filtra e mapeia os arquivos para incluir apenas o 'path'
    const filePathsToAnalyze = allFiles
      ...
      .map((file) => file.path); // Extrai apenas o path dos arquivos filtrados
